...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.checkBox_shuffle_tags = QCheckBox(Form)
        self.checkBox_shuffle_tags.setObjectName(u"checkBox_shuffle_tags")
        self.checkBox_shuffle_tags.setChecked(True)

        self.gridLayout.addWidget(self.checkBox_shuffle_tags, 4, 0, 1, 2)
...
#if QT_CONFIG(tooltip)
        self.checkBox_shuffle_tags.setToolTip(QCoreApplication.translate("Form", u"HIGHLY RECOMMENDED FOR LORA TRAINING", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_shuffle_tags.setText(QCoreApplication.translate("Form", u"Shuffle Tags", None))
#if QT_CONFIG(tooltip)
