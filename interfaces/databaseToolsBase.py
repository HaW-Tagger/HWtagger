...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 434, 368))
        ...
        self.page.setGeometry(QRect(0, 0, 436, 303))
        ...
        self.page_2.setGeometry(QRect(0, 0, 436, 303))
        ...
        self.gridLayout_3.addWidget(self.pushButton_reset_manual_score, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_discard_image, 12, 0, 1, 1)

        self.pushButton_purge_manual = QPushButton(self.page_2)
        self.pushButton_purge_manual.setObjectName(u"pushButton_purge_manual")

        self.gridLayout_3.addWidget(self.pushButton_purge_manual, 10, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_auto_tag, 1, 0, 1, 1)

        self.pushButton_auto_score = QPushButton(self.page_2)
        self.pushButton_auto_score.setObjectName(u"pushButton_auto_score")

        self.gridLayout_3.addWidget(self.pushButton_auto_score, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_refresh_tags_from_gelbooru_and_rule34, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_only_tag_characters, 2, 0, 1, 1)

        self.toolBox.addItem(self.page_2, u"Batch Operations:")
        self.page_3 = QWidget()
        self.page_3.setObjectName(u"page_3")
        self.page_3.setGeometry(QRect(0, 0, 436, 303))
...
#if QT_CONFIG(tooltip)
        self.plainTextEdit_secondary_trigger_tags.setToolTip(QCoreApplication.translate("Form", u"Tags in the main and secondary are placed in front of the other tags. Look at token separator if you want to use token separator with your exporting. You don't need token separator if the count of the trigger tags are constant.\n"
"\n"
"\n"
"The tag order in main trigger tag(s) are unshuffled\n"
"The tag order in secondary trigger tag(s) is shuffled\n"
"The other tags are shuffled.\n"
"\n"
"\n"
"Here's an example with no token separator, 1 main trigger word, and 3 secondary trigger word: main_trigger tag, secondary_tag_3, secondary_tag_1, secondary_tag_2, rest of the tags, ...", None))
#endif // QT_CONFIG(tooltip)
